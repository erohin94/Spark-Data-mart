...
Делаю `unpersist()` - если планирую дальше делать какие то преобразования с другими таблицами и датафреймы которые закешировал больше не нужны. 

Если вообще завершил всю работу то делаю спарк стоп, он так же очищает кэш и тд. Т.е просто завершаю спрак сессию, чтобы освободить все ресурсы, ядра и тд. `spark.stop()`. Освободил и отдал свои ресурсы на общее пользование. Автоматически все завершится.
